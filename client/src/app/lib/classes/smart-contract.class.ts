import ISmartContract from '@/app/lib/interfaces/smart-contract.interface'
import ConsentAudit from '@/app/data/context/blockchain/ethereum/contracts/ConsentAudit.json'
...
export default class SmartContract implements ISmartContract {
    ...
    async getConsents(hash: string) {
        ...
        // contract.methods.getConsents(hash).call({
        //     from: '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266',
        // }).then((consents: any) => {
        //     console.log('Consents:', consents)
        //     return consents
        // })
        const consents = await contract.methods.getConsents(hash).call({
            from: '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266',
        })
        console.log('Consents:', consents)
        return consents
